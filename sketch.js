...
function setup(){
  ...
  gameover = createSprite(width/2,height/2,600,20)
  gameover.addImage("gameover" ,gameoverImage)
  gameover.scale=0.7

  restart = createSprite(width/2,height/2+50,600,20)
...
function draw(){
  ...
  //trex jump  
  if(keyDown("space")&&trex.y>=height-60){trex.velocityY=-10;jump.play();}
...
//calling cloud and cactus function
  ...
  textSize(20) 
  text ("Score = "+ score,width/2+200,height/2-220)
  ...
  function Cactus(){
  if(frameCount%100===0){
  var cactus =createSprite(width,height-40,10,40) 
